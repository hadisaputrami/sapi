...
class BiodataAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $this->biodataRepository->pushCriteria(new LimitOffsetCriteria($request));
        $biodatas = $this->biodataRepository->all();

        return $this->sendResponse($biodatas->toArray(), 'Biodatas retrieved successfully');
    }
    ...
    public function store(CreateBiodataAPIRequest $request)
    {
        ...
        $biodatas = $this->biodataRepository->create($input);

        return $this->sendResponse($biodatas->toArray(), 'Biodata saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse($biodata->toArray(), 'Biodata retrieved successfully');
    }
    ...
    public function update($id, UpdateBiodataAPIRequest $request)
    {
        ...
        return $this->sendResponse($biodata->toArray(), 'Biodata updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return $this->sendResponse($id, 'Biodata deleted successfully');
    }
}
